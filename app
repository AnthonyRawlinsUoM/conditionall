...
function test {
    ...
    export DISPLAY=:0
    ./com.github.anthonyrawlinsuom.conditionall --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.anthonyrawlinsuom.conditionall-pot
    ninja com.github.anthonyrawlinsuom.conditionall-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.anthonyrawlinsuom.conditionall "${@:2}"
    ;;
"test")
    test
    ;;
